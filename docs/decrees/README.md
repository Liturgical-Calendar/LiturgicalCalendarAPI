...
- `notitiae-responsa-sweep.md` — the account of the *Dubia* / *Responsa* sweep of #986: which pages it opened and
  why each was or was not recorded. Regenerate it only alongside a fresh pass over the same sections.
