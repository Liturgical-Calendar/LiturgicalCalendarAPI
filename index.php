...
$messages = array_merge($messages, [
    ...
    "EASTER_CALCULATOR" => [
        "de" => "Obwohl dieses Skript zumindest vorerst nicht speziell als API konzipiert wurde, berechnet es das Osterdatum, sowohl Gregorianisch als auch Julianisch, " .
        ...
        "en" => "Though not specifically designed, at least for now, as an API, this script calculates the Date of Easter, both Gregorian and Julian, " .
        ...
        "es" => "Aunque no está diseñado específicamente, al menos por ahora, como API, este script calcula la fecha de Pascua, tanto gregoriana como juliana, " .
        ...
        "fr" => "Bien qu'il ne soit pas spécifiquement conçu, du moins pour l'instant, en tant qu'API, ce script calcule la date de Pâques, à la fois grégorienne et julienne, " .
        ...
        "it" => "Sebbene non pensata specificamente come una API, questo script calcola la Data di Pasqua, sia Gregoriana che Giuliana, " .
        ...
        "pt" => "Embora não tenha sido projetado especificamente, pelo menos por agora, como uma API, este script calcula a Data da Páscoa, tanto Gregoriana quanto Juliana, " .
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card shadow m-2">
                    ...
                    <div class="card-body">
                        <div><a href="LitCalEngine.php" class="btn btn-primary"><?php _e("View API endpoint"); ?></a></div>
            ...
            <div class="col-md-6">
                <div class="card shadow m-2">
                    ...
                    <div class="card-body">
                        ...
                        <div><a href="easter.php" class="btn btn-primary"><?php _e("Calculate the Date of Easter"); ?></a></div>
                    </div>
                </div>
            </div>
        </div>
