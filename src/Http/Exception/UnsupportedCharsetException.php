...
class UnsupportedCharsetException extends ApiException
{
    public function __construct(string $message = 'Charset of request Content-Type is not supported', ?\Throwable $previous = null)
    {
        parent::__construct(
            $message,
