...
/**
 * Carries the handler's shared mutable state into a PrecedenceResolver so the
 * extracted computation behaves identically to the inline version.
 *
 * The message sink is passed by reference so that any message appended by a
 * resolver lands in the handler's own `$this->Messages` array, in the exact same
