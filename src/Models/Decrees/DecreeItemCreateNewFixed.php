...
final class DecreeItemCreateNewFixed extends DecreeEventData
{
     ...
     *
     * @param \stdClass&object{event_key:string,name:string,calendar:string,day:int,month:int,color:string[],grade:int,common:string[]} $data The stdClass object containing the properties of the class.
